...
class UploadPhotoProfileCubit extends Cubit<UploadPhotoProfileState> {
  ...
  Future<void> uploadPhotoProfile(String apiToken, String idProfile, String photoProfile) async {
    ApiReturnValue<Profile> result =
        await ProfileServices.editPhotoProfile(apiToken, idProfile, photoProfile);
