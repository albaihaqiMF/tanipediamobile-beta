...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ProfileState stateProfile = context.watch<GetProfileCubit>().state;
    final data = (context.watch<GetProfileCubit>().state as GetProfileLoaded);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: (stateProfile is GetProfileLoaded)
            ? ListView(
                children: [
                  SizedBox(height: 10),
                  Row(
  ...
  void takePhoto(ImageSource source, BuildContext context) async {
    ...
    if (_pickedFile != null) {
      ...
      await context
          ...
          .uploadPhotoProfile(token:apiToken, idProfile:idProfil, photoProfile:imagePath);
      Get.back();
      ...
      try {
        if (state is UploadPhotoProfileLoaded) {
          ...
          setState(() {
            _updateFotoProfil = ApiUrl.baseURL + _dataImage;
